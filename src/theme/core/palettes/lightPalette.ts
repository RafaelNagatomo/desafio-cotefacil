...
export const LightPalette = (tokens: ColorSchema): PaletteSchema => {
    ...
    return {
        primary: {
            ...
            hover: c.brand.primary[400],
        },

        secondary: {
            main: c.brand.secondary[500],
        ...
        surface: {
            ...
            background: c.neutral.grey[50],
            backgroundVariant: c.neutral.grey[100],
            surface: c.neutral.grey[200],
            surfaceVariant: c.neutral.grey[300],
            textPrimary: c.neutral.grey[900],
            textSecondary: c.neutral.grey[700],
            border: c.neutral.grey[600],
            divider: c.neutral.grey[400],
        },
