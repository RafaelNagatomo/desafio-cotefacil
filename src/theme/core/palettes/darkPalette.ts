...
export const DarkPalette = (tokens: ColorSchema): PaletteSchema => {
    ...
    return {
        ...
        information: {
            ...
            hover: c.feedback.information[300],
        },
